...
import com.example.myblog.dao.MessageRepository;
...
public class MessageServiceImpl implements MessageService{
    ...
    public void findParentMessage(Message message) {
        ...
        if(parentMessage == null){
            ...
            Message parent = messageRepository.findById(parentMessage.getId()).get();
                ...
                Runnable task = new Runnable() {//异步发送邮件通知
                    ...
                    public void run() {
                        try {
                            ...
                            String replace1 = content1.replace("/img", "http://xiongsihao.com/images");
                            String replace2 = content2.replace("/img","http://xiongsihao.com/images");
